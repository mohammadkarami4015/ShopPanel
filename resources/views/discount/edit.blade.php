        ...
        <div
            ...
            <div class="ibox">
                <div class="ibox-content">
                    <form method="POST" id="form" action="{{ route('discount.update',$discount) }}" class="form-horizontal"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="title" type="text" class="form-control" name="max_discount_price"
                                       value="{{ $discount->max_discount_price}}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="title" type="text" class="form-control" name="number_of_usage"
                                       value="{{ $discount->number_of_usage}}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="title" type="text" class="form-control" name="number_of_usage_for_user"
                                       value="{{ $discount->number_of_usage_for_user}}">
                            ...
                            <div class="col-md-6">
                                <select class="form-control select2 select2-dropdown"
                                    ...
                                    @foreach($products as $product)
                                        <option {{ in_array($product->id,$discountProducts) ? 'selected' : ' '}} value="{{$product->id}}">{{$product->title}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select data-placeholder="انتخاب محصولات" multiple class="form-control select2 select2-dropdown" name="except_products[]"  >
                                    ...
                                    @foreach($products as $product)
                                        <option {{ in_array($product->id,$discountExceptProducts) ? 'selected' : ' '}} value="{{$product->id}}">{{$product->title}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <select data-placeholder="انتخاب دسته بندی" class="form-control select2 select2-dropdown" multiple name="categories[]" id="type" >
                                    ...
                                    @foreach($categories as $category)
                                        <option {{ in_array($category->id,$discountCategories) ? 'selected' : ' '}}  value="{{$category->id}}">{{$category->title}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select data-placeholder="انتخاب دسته بندی" class="form-control select2 select2-dropdown" multiple name="except_categories[]" id="type" >
                                    ...
                                    @foreach($categories as $category)
                                        <option {{ in_array($category->id,$discountExceptCategories) ? 'selected' : ' '}}  value="{{$category->id}}">{{$category->title}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
